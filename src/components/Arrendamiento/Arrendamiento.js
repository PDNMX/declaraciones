        ...
        <Grid container spacing={24}>
          ...
          <Grid item xs={2}>
            <FormControl className={classes.select}>
              ...
              <Select
                value={
                  data.datos_arrendamiento.ingreso_bruto_anual.moneda.codigo
                }
          ...
          <Grid item xs={2}>
            <FormControl className={classes.select}>
              ...
              <Select
                value={
                  data.datos_arrendamiento.ingreso_bruto_anual.unidad_temporal
                    .codigo
                }
          ...
          <Grid item xs={3}>
            <TextField
              ...
              className={classes.textField}
              value={
                data.datos_arrendamiento.ingreso_bruto_anual.duracion_frecuencia
              }
          ...
          <Grid item xs={3}>
            <TextField
              ...
              className={classes.textField}
              value={
                data.datos_arrendamiento.ingreso_bruto_anual.fecha_transaccion
              }
          ...
          <Grid item xs={12}>
            <Direccion
              data={data.datos_arrendamiento.domicilio_actividad}
