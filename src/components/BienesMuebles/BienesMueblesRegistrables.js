        ...
        <Grid container spacing={24}>
          ...
          <Grid item xs={2}>
            <FormControl className={classes.select}>
              ...
              >
                {data.catEntidadesFederativas.map(catEntidadesFederativasFederativas => (
                  <MenuItem
                    key={catEntidadesFederativasFederativas.cve_agee}
                    value={catEntidadesFederativasFederativas.cve_agee}
                  >
                    {catEntidadesFederativasFederativas.nom_agee}
                  </MenuItem>
                ))}
              </Select>
            </FormControl>
