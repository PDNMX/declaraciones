...
import Tabla from "./TablaMenbresias";
        ...
        <Grid container spacing={24}>
          <Grid item xs={2}>
            <FormControl className={classes.select}>
              ...
              >
                {data.catTiposInstituciones.map(tipoInstitucion => (
                  <MenuItem
          ...
          <Grid item xs={2}>
            <FormControl className={classes.select}>
              ...
              >
                {data.catNaturalezaMembresias.map(naturalezaMembresia => (
                  <MenuItem
                    key={naturalezaMembresia.codigo}
                    value={naturalezaMembresia.codigo}
                  >
                    {naturalezaMembresia.valor}
                  </MenuItem>
                ))}
              </Select>
            </FormControl>
