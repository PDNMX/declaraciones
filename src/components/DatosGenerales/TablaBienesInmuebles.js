      ...
      <Table className={classes.table}>
        <TableHead>
          <TableRow>
            ...
            <CustomTableCell>Superficie del terreno</CustomTableCell>
            <CustomTableCell>Superficie de construcción</CustomTableCell>
            ...
            <CustomTableCell>Numero de escritura publica</CustomTableCell>
            <CustomTableCell>numero de registro publico</CustomTableCell>
            <CustomTableCell>Folio real</CustomTableCell>
            <CustomTableCell>Fecha de contrato</CustomTableCell>
            <CustomTableCell>Forma de adquisición</CustomTableCell>
            <CustomTableCell>Razon social de quien se adquirió el inmueble</CustomTableCell>
            ...
            <CustomTableCell>Valor catastral</CustomTableCell>
          ...
          {data.map((item, index) => {
            return (
              <TableRow className={classes.row} key={index}>
                ...
                <CustomTableCell>{item.superficie_terreno}</CustomTableCell>
                <CustomTableCell>{item.superficie_construccion}</CustomTableCell>
                <CustomTableCell>{item.titular.valor}</CustomTableCell>
                <CustomTableCell>{item.porcentaje_propiedad}</CustomTableCell>
                <CustomTableCell>{item.nombre_copropietario.nombres}</CustomTableCell>
                <CustomTableCell>{item.identificacion_bien.numero_escritura_publica}</CustomTableCell>
                <CustomTableCell>{item.identificacion_bien.numero_registro_publico}</CustomTableCell>
                <CustomTableCell>{item.identificacion_bien.folio_real}</CustomTableCell>
                <CustomTableCell>{item.identificacion_bien.fecha_contrato}</CustomTableCell>
                <CustomTableCell>{item.forma_adquisicion.valor}</CustomTableCell>
                <CustomTableCell>{item.nombre_denominacion_quien_adquirio}</CustomTableCell>
                <CustomTableCell>{item.rfc_quien_adquirio}</CustomTableCell>
                <CustomTableCell>{item.curp_quien_adquirio}</CustomTableCell>
                <CustomTableCell>{item.relacion_persona_adquirio.valor}</CustomTableCell>
                ...
                <CustomTableCell>{item.valor_catastral}</CustomTableCell>

                <CustomTableCell>{item.domicilio_bien.pais.valor}</CustomTableCell>
