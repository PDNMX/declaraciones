      ...
      <Table className={classes.table}>
        <TableHead>
          <TableRow>
            ...
            <CustomTableCell>Tipo de obligación</CustomTableCell>
            <CustomTableCell>Número de cuenta, contrato o identificador de la obligación</CustomTableCell>
            ...
            <CustomTableCell>Fecha en la que se generó el obligación</CustomTableCell>
            <CustomTableCell>Monto original de la obligación</CustomTableCell>
            ...
            <CustomTableCell>Montos abonados a favor de la obligación</CustomTableCell>
            <CustomTableCell>Plazo de la obligación</CustomTableCell>
            <CustomTableCell>Unidad de medida del plazo</CustomTableCell>
            <CustomTableCell>Titular</CustomTableCell>
            <CustomTableCell>Porcentaje de la obligación del titular</CustomTableCell>
          ...
          {data.map((item, index) => {
            return (
              <TableRow className={classes.row} key={index}>
                ...
                <CustomTableCell>{item.fecha_obligacion}</CustomTableCell>
                ...
                <CustomTableCell>{item.plazo_obligacion}</CustomTableCell>
                <CustomTableCell>{item.unidad_medida_plazo.valor}</CustomTableCell>
                <CustomTableCell>{item.titularidad_obligacion.valor}</CustomTableCell>
                <CustomTableCell>{item.porcentaje_obligacion_titular}</CustomTableCell>
