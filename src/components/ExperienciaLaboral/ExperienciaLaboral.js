        ...
        <Grid container spacing={24}>
          ...
          <Grid item xs={2}>
            <FormControl className={classes.select}>
              ...
              >
                {data.catNivelGobierno.map(dato => (
          ...
          <Grid item xs={2}>
            <FormControl className={classes.select}>
              ...
              >
                {data.catPoderJuridico.map(dato => (
                  <MenuItem key={dato.codigo} value={dato.codigo}>
                    {dato.valor}
                  </MenuItem>
                ))}
          ...
          <Grid item xs={2}>
            <TextField
              ...
              onChange={handleChange("unidad_administrativa")}
              margin="normal"
            />
          </Grid>
          <Grid item xs={2}>
          ...
          <Grid item xs={2}>
            <TextField
              ...
              onChange={handleChange("jerarquia_rango")}
              margin="normal"
            />
          </Grid>
          <Grid item xs={2}>
