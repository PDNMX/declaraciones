...
import Tabla from "./TablaPremios";
  ...
  return (
    <Card className={classes.card}>
      <CardContent>
        ...
        <Grid container spacing={24}>
          <Grid item xs={3}>
            <TextField
              ...
              value={data.datos_premios.nombre_denominacion}
          ...
          <Grid item xs={2}>
            <FormControl className={classes.select}>
              ...
              <Select
                value={data.datos_premios.sector_industria.codigo}
          ...
          <Grid item xs={2}>
            <FormControl className={classes.select}>
              ...
              <Select
                value={data.datos_premios.tipo_actividad_servicio.codigo}
          ...
          <Grid item xs={3}>
            <TextField
              id="grado"
              label="Descripción del tipo de premio"
              className={classes.textField}
              value={data.datos_premios.descripcion_premio}
              onChange={handleChange("descripcion_premio")}
              margin="normal"
            />
          </Grid>
          <Grid item xs={3}>
            <TextField
              ...
              className={classes.textField}
              value={data.datos_premios.ingreso_bruto_anual.valor}
          ...
          <Grid item xs={2}>
            <FormControl className={classes.select}>
              ...
              <Select
                value={data.datos_premios.ingreso_bruto_anual.moneda.codigo}
          ...
          <Grid item xs={2}>
            <FormControl className={classes.select}>
              ...
              <Select
                value={
                  data.datos_premios.ingreso_bruto_anual.unidad_temporal.codigo
                }
          ...
          <Grid item xs={3}>
            <TextField
              ...
              label="Duración"
              className={classes.textField}
              value={data.datos_premios.ingreso_bruto_anual.duracion_frecuencia}
          ...
          <Grid item xs={3}>
            <TextField
              ...
              label="Fecha de pago"
              className={classes.textField}
              value={data.datos_premios.ingreso_bruto_anual.fecha_transaccion}
          ...
          <Grid item xs={3}>
            <TextField
              ...
              label="Observaciones"
              className={classes.textField}
              value={data.datos_premios.observaciones}
          ...
          <Grid item xs={12}>
            <Direccion
              data={data.datos_premios.domicilio}
        ...
        <Grid container spacing={24}>
          <Tabla data={data.premios} buttonClick={removeClick} />
        </Grid>
      </CardContent>
    </Card>
  );
